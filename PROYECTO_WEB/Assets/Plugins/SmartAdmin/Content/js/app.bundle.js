var myapp_config = {
  ...
  isIE: window.navigator.userAgent.indexOf("Trident/") > 0 == !0,
  debugState: !0,
  rippleEffect: !0,
  ...
  e.fn.extend({
    navigation: function (o) {
      var t = e.extend(
        ...
        n = e(this);
      n.hasClass(t.initClass)
        ? myapp_config.debugState &&
          console.log(n.get(0) + " this menu already exists")
        : (n.addClass(t.initClass),
          n.find("li").each(function () {
            0 !== e(this).find("ul").length &&
              (e(this)
                .find("a:first")
                .append("<b class='collapse-sign'>" + t.closedSign + "</b>"),
          ...
          n.find("li a").on("mousedown", function (o) {
            0 !== e(this).parent().find("ul").length &&
              (t.accordion &&
                (e(this).parent().find("ul").is(":visible") ||
                  ((parents = e(this).parent().parents("ul")),
                  (visible = n.find("ul:visible")),
                  visible.each(function (o) {
                    var n = !0;
                    parents.each(function (e) {
                      if (parents[e] == visible[o]) return (n = !1), !1;
                    }),
                      n &&
                        e(this).parent().find("ul") != visible[o] &&
                        e(visible[o]).slideUp(
                          t.speed + 300,
                          t.animate,
                          function () {
              ...
              !e(this).parent().find("ul:first").hasClass("active")
                ? e(this)
                    .parent()
                    .find("ul:first")
                    .slideUp(t.speed + 100, t.animate, function () {
                      e(this)
                        .parent("li")
                        .removeClass("open")
                        .find("a:first")
                ...
                : e(this)
                    .parent()
                    .find("ul:first")
                    .slideDown(t.speed, t.animate, function () {
                      e(this)
                        .parent("li")
                        .addClass("open")
                        .find("a:first")
  ...
  (function (e) {
    ...
    function t(t, n) {
      var i = e(t),
        a = t;
      function s(e) {
        void 0 !== n[e] && n[e].call(a);
      }
      return (
        (n = e.extend({}, e.fn[o].defaults, n)),
        (function () {
          i.css("margin-left", "0px"),
            ...
            e.map(i.children("li:not(.nav-title)"), function (o) {
              return e(o).outerWidth(!0);
            });
          var o,
            t,
            a,
            r,
            l = function () {
              (o = e("#" + n.wrapperId).outerWidth()),
                (a = e
                  .map(i.children("li:not(.nav-title)"), function (o) {
                    return e(o).outerWidth(!0);
                  })
                  .reduce(function (e, o) {
                    return e + o;
                  }, 0)),
                (t = parseFloat(i.css("margin-left")));
            };
          e("#" + n.wrapperId + "-left-btn").click(function (e) {
            l(),
              t < 0
                ? (r = Math.min(t + o, 0))
                : ((r = t), console.log("left end")),
              i.css({ marginLeft: r }),
              e.preventDefault();
          }),
            e("#" + n.wrapperId + "-right-btn").click(function (e) {
              l(),
                -t + o < a
                  ? (r = Math.max(t - o, -(a - o)))
                  : ((r = t), console.log("right end")),
                i.css({ marginLeft: r }),
                e.preventDefault();
            }),
            s("onInit");
    ...
    (e.fn[o] = function (n) {
        ...
        return (
          this.each(function () {
            if (
              ...
              "function" != typeof e.data(this, "plugin_" + o)[a]
            )
              throw new Error("Method " + a + " does not exist on jQuery." + o);
            i = e.data(this, "plugin_" + o)[a].apply(this, s);
          }),
          void 0 !== i ? i : this
        );
      }
      if ("object" == typeof n || !n)
        return this.each(function () {
          e.data(this, "plugin_" + o) ||
            e.data(this, "plugin_" + o, new t(this, n));
        });
    }),
      (e.fn[o].defaults = {
        onInit: function () {},
...
var initApp = (function (e) {
    return (
      (e.listFilter = function (e, o, t) {
        t ? $(t).addClass("js-list-filter") : $(e).addClass("js-list-filter"),
          $(o)
            .change(function () {
              var o = $(this).val().toLowerCase(),
                t = $(e).next().filter(".js-filter-message");
              return (
                o.length > 1
                  ? ($(e)
                      .find(
                    ...
                    t &&
                      t.text(
                        "showing " +
                          $(e).find("li.js-filter-show").length +
                          " from " +
                          $(e).find("[data-filter-tags]").length +
                          " total"
                      ))
                  : ($(e)
      ...
      (e.updateTheme = function (e, o) {
        $(myapp_config.mythemeAnchor).length
          ? $(myapp_config.mythemeAnchor).attr("href", e)
          : $("head").append(
              $("<link>", {
      ...
      (e.resetSettings = function () {
        myapp_config.root_.removeClass(function (e, o) {
          return (
            o.match(/(^|\s)(nav-|header-|footer-|mod-|display-)\S+/g) || []
          ).join(" ");
        }),
          ...
          case myapp_config.root_.hasClass("nav-function-fixed") &&
            ...
            void 0 !== $.fn.slimScroll
              ? (myapp_config.navAnchor.slimScroll({
                ...
                document.getElementById(myapp_config.navHorizontalWrapperId) &&
      ...
      (e.domReadyMisc = function () {
        ...
        if (
          (initApp.checkNavigationOrientation(), myapp_config.activateLastTab)
        ) {
        ...
        if (
          ...
          myapp_config.root_.on(
            ...
            function (e) {
                  ...
                  (s = $(this).closest(".panel"))
                    ...
                    .on("hidden.bs.collapse", function () {
                      s.addClass("panel-collapsed"),
                        myapp_config.debugState &&
                          console.log(
                            "panel id:" + s.attr("id") + " | action: collapsed"
                          );
                    });
                  break;
                case "panel-fullscreen" === o:
                  (s = $(this).closest(".panel")).toggleClass(
                    "panel-fullscreen"
                  ),
                    myapp_config.root_.toggleClass("panel-fullscreen"),
                    myapp_config.debugState &&
                      console.log(
                        "panel id:" + s.attr("id") + " | action: fullscreen"
                      );
                  break;
                case "panel-close" === o:
                    ...
                    r = function () {
                      s.fadeOut(500, function () {
                        $(this).remove(),
                          myapp_config.debugState &&
                            console.log(
                              "panel id:" + s.attr("id") + " | action: removed"
                            );
                      });
                    };
                  "undefined" != typeof bootbox
              ...
              $(this).tooltip("hide"),
                myapp_config.debugState &&
                  console.log("data-action clicked: " + o),
                e.stopPropagation(),
                e.preventDefault();
            }
          ),
...
var color = {
  ...
  info: {
    _50:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-info-50").css("color")
      ) || "#9acffa",
    _100:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-info-100").css("color")
      ) || "#82c4f8",
    _200:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-info-200").css("color")
      ) || "#6ab8f7",
    _300:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-info-300").css("color")
      ) || "#51adf6",
    _400:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-info-400").css("color")
      ) || "#39a1f4",
    _500:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-info-500").css("color")
      ) || "#2196F3",
    _600:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-info-600").css("color")
      ) || "#0d8aee",
    _700:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-info-700").css("color")
      ) || "#0c7cd5",
    _800:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-info-800").css("color")
      ) || "#0a6ebd",
    _900:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-info-900").css("color")
      ) || "#0960a5",
  },
  warning: {
    _50:
  ...
  danger: {
    _50:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-danger-50").css("color")
      ) || "#feb7d9",
    _100:
      rgb2hex(
        myapp_config.mythemeColorProfileID
  ...
  fusion: {
    _50:
      rgb2hex(
        myapp_config.mythemeColorProfileID.find(".color-fusion-50").css("color")
      ) || "#909090",
    _100:
      rgb2hex(
        myapp_config.mythemeColorProfileID
...
$(document).ready(function () {
  $.ajax({
    ...
    error: function () {
      $("body").html(
        $(
          '<div class="alert alert-danger p-3 m-4"> <h4>You are using an illigal Copy of SmartAdmin WebApp. Please purchase your copy through <a href="https://wrapbootstrap.com/theme/smartadmin-responsive-webapp-WB0573SK0"> https://wrapbootstrap.com/theme/smartadmin-responsive-webapp-WB0573SK0</a><br><small class="m-0">Your IP and Geolocation has been recorded.</small></h4></div>'
        )
      );
    },
    success: function () {},
